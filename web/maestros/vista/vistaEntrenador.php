...
<head>
    ...
    <script src="web/maestros/js/maestroEntrenador.js" type="text/javascript"></script>    
</head>

<body class="fuente">
   <div id="principal" align="center">
        <div id="cuerpo">
            <div style="font-size:150%;padding:20px"><h3>Gestor de Entrenadores </h3></div>
            <table id = "grilla"></table>
            <div id="pager2"></div>
        </div>
    </div>

    <div id="formEntrenador" class="modal fade">
